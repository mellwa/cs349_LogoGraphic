...
NextFrameButton::NextFrameButton(const string & name, const string & label) : Button(name,label)
{
...
void NextFrameButton::PaintComponent(Graphics* g) {
    // TODO CS349
if(this->press_in && this->in_here){
    ...
    vertices.push_back(Point(25,15));
